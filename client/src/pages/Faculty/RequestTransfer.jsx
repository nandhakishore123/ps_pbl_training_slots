        ...
        <div className={styles.groups}>
          {loading ? (
            ...
            <>
              ...
              <div className={`${tStyles.calendarCard} ${tStyles.accentPurple}`}>
                <h4 className={tStyles.cardTitle}>
                  <span className={`${tStyles.titleIcon} ${tStyles.purple}`}>
              ...
              <div className={tStyles.transferGrid}>
                ...
                <div className={`${tStyles.card} ${tStyles.accentOrange}`}>
                  <h3 className={tStyles.cardTitle}>
                    <span className={`${tStyles.titleIcon} ${tStyles.orange}`}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <form onSubmit={handleSubmit} className={`${tStyles.card} ${tStyles.accentGreen}`}>
                  <h3 className={tStyles.cardTitle}>
                    <span className={`${tStyles.titleIcon} ${tStyles.green}`}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {selectedSource ? (
                      <div className={tStyles.slotPill}>
                        ...
                        <button
                          ...
                          className={tStyles.clearBtn}
                        >
                          Clear
                        </button>
                      </div>
                    ) : (
                      <div className={tStyles.emptyBox}>
                ...
                {/* Logs Table */}
                <div className={`${tStyles.card} ${tStyles.fullWidth} ${tStyles.accentGold}`}>
                  <h3 className={tStyles.cardTitle}>
                    <span className={`${tStyles.titleIcon} ${tStyles.gold}`}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <tbody>
                          {transfers.map((t) => (
                            <tr key={t.transfer_id}>
                              <td>
                                <div className={tStyles.cellPrimary}>{t.venue_name}</div>
                                <div className={tStyles.cellTime}>
                                  {formatTime(t.start_time)} - {formatTime(t.end_time)}
                                </div>
                                <div className={tStyles.cellMeta}>
                                  Loc: {t.location}
                                </div>
                              </td>
                              <td>
                                {t.target_venue_name ? (
                                  <div>
                                    <div className={tStyles.cellFreeVenue}>{t.target_venue_name} (Free Slot)</div>
                                    <div className={tStyles.cellTime}>
                                  ...
                                  <div>
                                    <div className={tStyles.cellSubName}>{t.to_faculty_name}</div>
                                    <div className={tStyles.cellMeta}>
                                      Dept: {t.to_faculty_dept || '—'}
                                    </div>
                                  </div>
                                ) : (
                                  <span className={tStyles.cellDash}>—</span>
                                )}
                              </td>
                              <td className={tStyles.cellDate}>
                                {t.transfer_date ? new Date(t.transfer_date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' }) : '—'}
                              </td>
                              <td className={tStyles.cellReason}>
                                {t.reason}
                              </td>
