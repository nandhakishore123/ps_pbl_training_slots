...
import styles from './PBLSlots.module.css'
...
export default function PBLSlots() {
  const { pblSlots, faculty, deletePblSlot } = useData()
  const { showToast } = useApp()
  const [addOpen, setAddOpen] = useState(false)

  const handleDelete = (index) => {
    deletePblSlot(index)
    showToast('PBL Slot deleted', false)
  }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.pageTitle}>PBL Slot Management</div>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                {pblSlots.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={6}>
                      <div className={styles.empty}>No PBL slots found</div>
                    </td>
                  </tr>
                )}
              </tbody>
