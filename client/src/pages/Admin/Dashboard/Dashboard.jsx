        ...
        <div className={styles.group}>
          ...
          <div className={styles.boxesGrid}>
            ...
            <NavBox
              ...
              label="Reward Points"
              desc="Full department leaderboard, rankings & per-student details"
            ...
            <NavBox
              ...
              label="All Bookings"
              desc="View every booking, attendance & results · export CSV"
            ...
            <NavBox
              ...
              label="Attendance"
              desc="Mark student attendance present/absent for any lab"
