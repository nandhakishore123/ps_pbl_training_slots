    ...
    <div className="ad-root">
      ...
      <div className="ad-wrap">
        ...
        {tab === 'returnables' && (() => {
          ...
          // Item rows are inline-styled on purpose: .ad-req, .ad-req-top and
          // .ad-req-items are shared with the Buying / Returns / Lab Purchases
          // tabs, so nothing here may add or alter a rule on them.
          ...
          const renderGroupCard = (g) => {
            const person = g.person_user_id != null
              ...
              : null;
            return (
              <div className="ad-req" key={g.key}>
                {/* alignItems set explicitly so the ✉ sits identically on both
                    pages now that the header is taller (.ad-req-top defaults to
                    flex-start, .ic-req-top to center). */}
                <div className="ad-req-top" style={{ alignItems: 'flex-start' }}>
                  <div style={{ minWidth: 0 }}>
                    <div className="ad-req-name">{g.name || '—'}
                      <span className="ad-req-reg">{g.ref || '—'}</span>
                    </div>
                    <div className="ad-req-meta">
                ...
                <div className="ad-req-items">
                  ...
                  {g.rows.map((r) => (
                    ...
                    >
                      ...
                      <span
                        className={`ad-pill ${RETURNABLE_PILL[r.status_label] || 'pending'}`}
                        style={{ flexShrink: 0 }}
                      >
                        {r.status_label}
                      </span>
          ...
          return (
            <>
              ...
              {/* ══ FILTER DROPDOWNS — REMOVABLE (start) ══
                  ...
                  above. Reuses .ad-label / .ad-select — the same idiom as the
              ...
              <div style={{ display: 'flex', gap: 14, marginBottom: 12, flexWrap: 'wrap', alignItems: 'flex-end' }}>
                <div>
                  <label className="ad-label" htmlFor="ad-ret-type">Type</label>
                  <select
                    id="ad-ret-type"
                    className="ad-select"
                ...
                <div>
                  <label className="ad-label" htmlFor="ad-ret-held">Held for</label>
                  <select
                    id="ad-ret-held"
                    className="ad-select"
                    value={heldForFilter}
