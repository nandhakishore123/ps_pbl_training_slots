        ...
        <div className="flex min-w-0 items-center gap-3">
          {showBack && (
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="grid h-9 w-9 place-items-center rounded-[var(--radius-md)] border border-slate-200 bg-white text-slate-700 transition hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)]/5 hover:text-[var(--color-primary)]"
              aria-label="Back"
              title="Back"
            >
          ...
          >
            <span className="grid h-9 w-9 place-items-center rounded-[var(--radius-md)] bg-[color:var(--color-secondary)] text-[var(--color-primary)]">
